...
const Sidebar = () => {
  return (
    <div className='w-[10%] h-[90%] flex flex-col items-center justify-between p-4 border-r border-[#dbdbdb]'>
        ...
        <div className="w-full h-fit flex flex-col items-center justify-start gap-[30px] ">
          <div className="p-[5px] cursor-pointer rounded-[10px] transition-all hover:scale-110 
            hover:bg-[#ffffff]/50 hover:backdrop-blur-md hover:border hover:border-[#ffffff]/30">
